...
save(strcat('Output_contours\variance_roi_crop_', currDateTime, '.mat'), 'evaluationData');

%% Pretty Print

fileID = fopen(strcat('Output_contours\variance_roi_crop_', currDateTime, '.txt'), 'w');
fprintf('----------------------------------------------------------------------------------------\n\n');

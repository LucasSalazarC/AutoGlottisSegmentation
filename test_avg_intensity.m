...
% files = {'FN002', 'FN005' ,'FP010_naso2', 'FN003_naso', 'FN005_naso', 'FP016_naso'};
...
%         avgImgIntensity = mean(mean(s(:,:,1)));
        ...
        figure(1), imshow(s(:,:,1)), title('Variance * Mask'), hold on
        plot(roiBorder(:,2), roiBorder(:,1), 'y*', 'MarkerSize', 1), hold off
